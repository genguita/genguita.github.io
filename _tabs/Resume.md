...
I was hired by the ENLIGHTEN european project, focused on non-line-of-sight (NLOS) imaging, which allows to see around corners by leveraging the time-of-flight of light. Knowing how light propagates through time, NLOS algorithms can reconstruct the appearance of objects by analyzing how indirect light bounces in a relay surface.
My main responsabilities in this role incuded:
...
Master's Thesis: [Application of the near infrared and polarization on transient imaging techniques](https://drive.google.com/drive/folders/1ee2LheGoHuJ-gIS1Q2hQ2IbKO39fKOVz?usp=sharing)

- Bachelor’s Degree in Computer Science, specialization in computing. Universidad de Zaragoza (2019 – 2023)  
Bachelor's Thesis: [Action detection during the cooking process using machine learning techniques](https://zaguan.unizar.es/record/146706?ln=es)
